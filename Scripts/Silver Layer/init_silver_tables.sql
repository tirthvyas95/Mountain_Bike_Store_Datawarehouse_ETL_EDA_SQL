...
==========================================================================================================================
Script Purpose:
	This script creats all the tables in the silver schema. dropping existing tables if they already exist.
	Run this script to define or redefine the DDL structure of the 'silver' Layer
